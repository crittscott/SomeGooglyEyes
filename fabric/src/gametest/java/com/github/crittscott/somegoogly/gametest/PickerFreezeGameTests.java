...
/**
 * Fabric GameTest entry points for {@link PickerFreezeGameTestsLogic}; see that class for the actual
 * assertions.
 */
public final class PickerFreezeGameTests implements FabricGameTest {
